...
// SPLIT all the names that are seperated by the string ', ', returns an 
...
// Use the method .LENGTH to have the amount of different names from
...
// remove the false enemy with REPLACE, remove comma and space to make sure
// it's organized
